...
export const mockMentorships: Mentorship[] = [
    {
        ...
        sessions: [
            { id: 101, sessionNumber: 1, date: '2023-10-15', time: '10:00', duration: 60, status: 'completed', topic: 'Revisión de Portafolio Inicial', menteeGoals: 'Obtener feedback sobre mis proyectos actuales.', rating: 5, feedback: '¡Sofia fue increíblemente útil!', mentorSurvey: { preparation: 'excellent', engagement: 'excellent', outcome: 'Definimos una estrategia clara para mejorar su portafolio.' } },
            { id: 102, sessionNumber: 2, date: '2023-11-05', time: '11:30', duration: 60, status: 'confirmed', topic: 'Profundizando en un Caso de Estudio', menteeGoals: 'Mejorar la narrativa de mi proyecto principal.' }
        ]
    },
    {
        id: 2,
    ...
    },
    {
        id: 3,
        mentor: mockMentors[0],
        mentee: { ...mockCurrentUserMentee, id: 105, name: 'Camila Rojas' },
        status: 'active',
