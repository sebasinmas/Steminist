...
const MentorshipProgress: React.FC<MentorshipProgressProps> = ({ mentorship, userRole, onScheduleSession, onUpdateSession, onAddAttachment, onCompleteSession, onShowTerminationModal }) => {
