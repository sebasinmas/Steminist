...
export const mockMentors: Mentor[] = [
    {
        ...
        rating: 4.9,
        reviews: 32,
        interests: ['Ciencia de Datos', 'Machine Learning', 'Python', 'Gestión de Producto'],
        ...
        mentorshipGoals: ['Orientación profesional', 'Desarrollo de habilidades técnicas', 'Preparación para entrevistas'],
    ...
    },
    {
        ...
        rating: 4.8,
        reviews: 25,
        interests: ['Diseño UX/UI', 'Design Systems', 'Figma', 'Investigación de Usuarios'],
        ...
        mentorshipGoals: ['Revisión de CV/Portafolio', 'Preparación para entrevistas', 'Networking en la industria'],
    ...
    },
    {
        ...
        rating: 5.0,
        reviews: 41,
        interests: ['Desarrollo de Software', 'Arquitectura de Sistemas', 'Cloud Computing', 'JavaScript'],
        ...
        mentorshipGoals: ['Desarrollo de habilidades técnicas', 'Orientación profesional', 'Balance vida-trabajo'],
    ...
    },
    {
        ...
        rating: 4.9,
        reviews: 18,
        interests: ['Emprendimiento', 'Sostenibilidad', 'Estrategia de Negocios', 'Biotecnología'],
        ...
        mentorshipGoals: ['Networking en la industria', 'Orientación profesional', 'Emprendimiento'],
